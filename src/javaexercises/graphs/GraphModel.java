...
public class GraphModel {
	...
	public void addEdge(String sourceId, String targetId) {
		...
		if (addedEdges.stream().anyMatch(e -> e.source.cellId.equals(sourceId) && e.target.cellId.equals(targetId))) {
			return;
		}
	...
	public void addBiEdge(String sourceId, String targetId, Integer valor) {
		...
		if (addedEdges.stream().anyMatch(
				e -> e.source.cellId.equals(sourceId) && e.target.cellId.equals(targetId) || e.target.cellId.equals(sourceId)
						&& e.source.cellId.equals(targetId))) {
			return;
		}
