...
public abstract class PaintTool extends Group {
    ...
    protected static void drawCircle(PaintModel model, int centerX, int centerY, double radiusX, double radiusY, Color color) {
    ...
    protected static void drawCirclePart(PaintModel model, double centerX, double centerY, double radiusX, double radiusY,
    ...
    protected static void drawLine(PaintModel model, double startX, double startY, double endX, double endY, Color color) {
