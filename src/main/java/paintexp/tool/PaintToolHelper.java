...
public final class PaintToolHelper {
	...
	public static void drawSquareLine(WritableImage image ,ObservableList<WritableImage> imageVersions , int startX, int startY, int w, Color color, double opacity) {
		for (int x = 0; x < w; x++) {
