...
public class PaintViewUtils {
    ...
    private static void finishResize(final WritableImage image, final SimpleToggleGroupBuilder groupBuilder, final TextField widthField,
            final TextField heightField, PaintModel paintModel) {
    ...
    private static void onResizeOptionsChange(final SimpleToggleGroupBuilder groupBuilder,
            final CheckBox keepProportion, final TextField changedField, final TextField otherField,
            final double ratio) {
