...
public class BrasiliaWordTest {
	...
	public void testOtherOccurrences() throws IOException {
		List<String> words = Arrays.asList("au-tô-no-mo", "ou-to-no", "di-nhei-ro", "sal-dar", "dês-mai-a-do",
				"U-ru-guai", "i-guais", "quais-quer", "u-ru-guai-a-na", "prai-a", "tei-a", "joi-a", "sa-bo-rei-e",
				"es-tei-o", "ar-roi-o", "con-lui-o", "tui-ui-ú", "du-e-to", "a-mên-do", "ca-a-tin-ga", "sa-ú-de",
				"flu-ir", "chu-va", "mo-lha", "es-ta-nho", "guel-ra", "a-que-la", "to-cha", "fi-lha", "ni-nho",
				"que-rer", "guei-xa", "bar-ro", "as-sun-to", "des-cer", "nas-ço", "es-xu-dar", "ex-ce-to", "car-ro",
				"nas-cer", "dês-ço", "ex-ces-so", "ab-do-me", "sub-ma-ri-no", "ap-ti-dão", "dig-no", "con-vic-ção",
				"as-tu-to", "ap-to", "cír-cu-lo", "ad-mi-tir", "ob-tu-rar", "a-pli-ca-ção", "a-pre-sen-tar", "a-brir",
				"re-tra-to", "de-ca-tlo", "ab-rup-to", "gnós-ti-co", "pneu-má-ti-co", "mne-mô-ni-co", "Sa-a-ra",
				"com-pre-en-do", "xi-i-ta", "vo-o", "pa-ra-cu-u-ba", "oc-ci-pi-tal", "in-te-lec-ção", "de-sa-ten-to",
				"di-sen-te-ri-a", "tran-sa-tlân-ti-co", "su-ben-ten-di-do", "sub-lin-gual", "su-ben-ten-der",
				"dis-fun-ção", "di-sen-te-ri-a", "su-per-mer-ca-do", "su-pe-ra-mi-go");
		for (String word : words) {
			String splitSyllables = BrasilianWordSyllableSplitter.splitSyllables(word.replaceAll("-", ""));
			Assert.assertEquals("The syllables don't match", word, splitSyllables);
		}
