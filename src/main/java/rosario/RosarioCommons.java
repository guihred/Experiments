...
import rosario.RosarioComparadorArquivos.CustomableTableCell;
...
public class RosarioCommons {
    ...
    static void atualizar(ObservableList<Medicamento> medicamentos,
    ...
    static FileChooser choseFile(String value) {
        ...
        FILE_CHOOSE.put(value, fileChooser2);
        return fileChooser2;
    }

    static void configurarFiltroRapido(TextField filterField, final TableView<Medicamento> medicamentosEstoqueTable,
    ...
    static void exportarMedicamentos(final TableView<Medicamento> medicamentosEstoqueTable,
    ...
    static ObservableList<Medicamento> getMedicamentosAnvisa(File selectedFile) {
        try {
    ...
    static ObservableList<Medicamento> getMedicamentosRosario(File file) {
        try {
    ...
    static ObservableList<Medicamento> getMedicamentosSNGPC(File file) {
        try {
    ...
    static void showImportDialog(File excel, ObservableList<String> items,
    ...
    static TableView<Medicamento> tabelaMedicamentos(boolean completa) {
