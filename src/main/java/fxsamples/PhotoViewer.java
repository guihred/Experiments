...
public class PhotoViewer extends Application {
	...
	final int factor = 40;
	SequentialTransition build = new SimpleSequentialTransitionBuilder().addTranslateTransition(tickerContent,
		scene.getWidth() * factor, scene.widthProperty(), tickerContent.widthProperty().negate())
