...
public class CheckersSquare extends StackPane {
    ...
    public CheckersSquare(@NamedArg("black") boolean black) {
        ...
        getChildren().add(new SimpleSvgPathBuilder()
            .content("m12.50 2.50c0 -0.78 -0.65 -1.42 -1.42 -1.42"
    ...
    public String toString() {
        return String.format("[state=%s, selected=%s, marked=%s, queen=%s]", state.get(), selected.get(), marked.get(),
            queen.get());
    }
}