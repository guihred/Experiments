...
//	|_| | |_  _|  | _||_| ||_| _|
	public Number3D(int number) {
		...
		Box rec4 = vertical();
		rec4.translateXProperty().bind(sizeProperty.multiply(-0.5));
		rec4.translateYProperty().bind(sizeProperty.multiply(-0.5));
		rec4.visibleProperty().bind(visibleIfNot(1, 2, 3, 7));
		Box rec5 = vertical();
		rec5.translateXProperty().bind(sizeProperty.multiply(-0.5));
		rec5.translateYProperty().bind(sizeProperty.multiply(0.5));
		rec5.visibleProperty().bind(visibleIfNot(1, 3, 4, 5, 7, 9));
		Box rec6 = vertical();
		rec6.translateXProperty().bind(sizeProperty.multiply(0.5));
		rec6.translateYProperty().bind(sizeProperty.multiply(-0.5));
		rec6.visibleProperty().bind(visibleIfNot(5, 6));
		Box rec7 = vertical();
		rec7.translateXProperty().bind(sizeProperty.multiply(0.5));
		rec7.translateYProperty().bind(sizeProperty.multiply(0.5));
