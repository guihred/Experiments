...
public class BrazilianVerbsTest {
    ...
    public static Collection<Entry<String, List<String>>> dataPresentMode() {
        return Arrays.asList(entry("ser", "sou", "és", "é", "somos", "sois", "são"),
            ...
            entry("medir", "meço", "medes", "mede", "medimos", "medis", "medem"),
            entry("subir", "subo", "sobes", "sobe", "subimos", "subis", "sobem"),
            entry("sumir", "sumo", "somes", "some", "sumimos", "sumis", "somem"),
            entry("coçar", "coço", "coças", "coça", "coçamos", "coçais", "coçam"),
            ...
            entry("despedir", "despeço", "despedes", "despede", "despedimos", "despedis", "despedem"),
