...
public class FXFileReadersTest extends ApplicationTest {
	...
	public void testExcelAndWordFile() throws Exception {
		...
		measureTime("ExcelService.exportList", () -> ExcelService.getExcel(medicamentosSNGPCPDF, campos,
	...
	public void testExcelService() {
		...
		measureTime("ExcelService.getExcel", () -> ExcelService.getExcel(medicamentosSNGPCPDF, campos,
				ResourceFXUtils.getOutFile("sngpcMeds.xlsx")));
	...
	public void testExcelService2() {
		...
		measureTime("ExcelService.getExcel",
				() -> ExcelService.getExcel(
						(i, s) -> medicamentos.subList(Integer.min(i, maxI), Integer.min(i + s, maxI)), campos,
						ResourceFXUtils.getOutFile("sngpcMeds.xlsx")));
	...
	private List<Object> getList() {
		...
		List<Object> asList = Arrays.asList(new PointCh4(2, 4), new LabeledPoint("Oi", 3, 5), PrimaryColor.RED,
				...
				new SnakeSquare(), new JapaneseLesson());
