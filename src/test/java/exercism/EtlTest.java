...
public class EtlTest {
	...
	public void testFullDataset() {
		Map<Integer, List<String>> old = ImmutableMap.<Integer, List<String>> builder()
				...
				.put(3, Arrays.asList("B", "C", "M", "P")).put(4, Arrays.asList("F", "H", "V", "W", "Y")).put(5, Arrays.asList("K"))
				.put(8, Arrays.asList("J", "X")).put(10, Arrays.asList("Q", "Z")).build();
		Map<String, Integer> expected = ImmutableMap.<String, Integer> builder().put("a", 1).put("b", 3).put("c", 3).put("d", 2).put("e", 1)
