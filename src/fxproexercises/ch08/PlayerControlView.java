...
public class PlayerControlView extends AbstractView {
    ...
    protected Node initView() {
        ...
        positionSlider.valueChangingProperty().addListener((ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) -> {
    ...
    private Button createPlayPauseButton() {
        pauseImg = new Image("https://cdn1.iconfinder.com/data/icons/material-audio-video/20/pause-circle-outline-128.png");
        playImg = new Image("https://cdn3.iconfinder.com/data/icons/google-material-design-icons/48/ic_play_circle_outline_48px-128.png");
